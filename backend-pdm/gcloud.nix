...
{ stdenv, lib, fetchurl, makeWrapper, python, cffi, cryptography, pyopenssl, crcmod, google-compute-engine, with-gce ? false }:
...
let
  ...
  sources = name: system: {
    ...
    x86_64-linux = {
      ...
      sha256 = "07rs7w87av8y9jw0192b1m7arxqmws30q0rfvp8aajkphgq5l2x3";
    };
  }.${system};
